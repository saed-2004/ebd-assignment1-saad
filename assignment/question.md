...
Hero: saad yaser the Warrior
Student ID: 16020507
GitHub account: saed-2004

A **Griffin** bars the way near **the Giza plateau**. It only falls to
the exact blow.
...
4. Your warcry — copy the line below exactly, including punctuation:
   ...
   "By the Giza plateau, the Griffin shatters!"
